...
function [Answer,Answer0,Cancelled]=IN_CoWBA_mb2(varargin)
% % 
% if nargin==1
%     Answer0=varargin{1};
% 
...
Formats(5,4).type = 'list';
Formats(5,4).style = 'list';
Formats(5,4).format = 'text'; % Answer will give value shown in items, disable to get integer
Formats(5,4).items = {'Non-linear Hopf','Linear Hopf','Ising'};
Formats(5,4).limits = [1 1]; % multi-select
Formats(5,4).size =  size_control;
...
Prompt(end+1,:) = {'Compute subject-level GEC', 'isGEC',[]};
